---
title: "Fast NMF for Single Cell and Spatial Data with BiocNMF"
author: "Your Name"
date: "`r Sys.Date()`"
output: BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{Fast NMF for Single Cell and Spatial Data with BiocNMF}
...
BiocNMF provides fast non-negative matrix factorization (NMF) for SingleCellExperiment and SpatialExperiment objects using the high-performance RcppML backend. NMF is useful for dimensionality reduction, feature extraction, and identifying patterns in genomic data.
...
sce <- runBiocNMF(sce, k = 10, verbose = FALSE)
...
sce <- runBiocNMF(sce, k = 15, assay = "logcounts", 
